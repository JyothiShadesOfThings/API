...
module.exports.PostUploadWoundPredictionCommentBeforeCleaning = async (req,res)=>{
    const upload_id = req.query.upload_id; 
    const satisfaction = req.query.satisfaction; 
    const comment = req.query.comment; 
    
   const query = dbconnection.query(`update wound.algo_wound_details_before_cleaning
